...
'updated_at' => '\DateTime',
'translated' => 'object',
'currencies' => '\Rundum\Shopware6\Model\CurrencyFlat',
'languages' => '\Rundum\Shopware6\Model\LanguageFlat',
'countries' => '\Rundum\Shopware6\Model\CountryFlat',
'payment_methods' => '\Rundum\Shopware6\Model\PaymentMethodFlat',
'shipping_methods' => '\Rundum\Shopware6\Model\ShippingMethodFlat',
'type' => '\Rundum\Shopware6\Model\SalesChannelTypeFlat',
'language' => '\Rundum\Shopware6\Model\LanguageFlat',
'customer_group' => '\Rundum\Shopware6\Model\CustomerGroupFlat',
'currency' => '\Rundum\Shopware6\Model\CurrencyFlat',
'payment_method' => '\Rundum\Shopware6\Model\PaymentMethodFlat',
'shipping_method' => '\Rundum\Shopware6\Model\ShippingMethodFlat',
'country' => '\Rundum\Shopware6\Model\CountryFlat',
'orders' => '\Rundum\Shopware6\Model\OrderFlat',
'customers' => '\Rundum\Shopware6\Model\CustomerFlat',
'domains' => '\Rundum\Shopware6\Model\SalesChannelDomainFlat',
'system_configs' => '\Rundum\Shopware6\Model\SystemConfigFlat',
'navigation_category' => '\Rundum\Shopware6\Model\CategoryFlat',
'footer_category' => '\Rundum\Shopware6\Model\CategoryFlat',
'service_category' => '\Rundum\Shopware6\Model\CategoryFlat',
'product_visibilities' => '\Rundum\Shopware6\Model\ProductVisibilityFlat',
'hreflang_default_domain' => '\Rundum\Shopware6\Model\SalesChannelDomainFlat',
'mail_header_footer' => '\Rundum\Shopware6\Model\MailHeaderFooterFlat',
'newsletter_recipients' => '\Rundum\Shopware6\Model\NewsletterRecipientFlat',
'mail_templates' => '\Rundum\Shopware6\Model\MailTemplateSalesChannelFlat',
'number_range_sales_channels' => '\Rundum\Shopware6\Model\NumberRangeSalesChannelFlat',
'promotion_sales_channels' => '\Rundum\Shopware6\Model\PromotionSalesChannelFlat',
'document_base_config_sales_channels' => '\Rundum\Shopware6\Model\DocumentBaseConfigSalesChannelFlat',
'product_reviews' => '\Rundum\Shopware6\Model\ProductReviewFlat',
'seo_urls' => '\Rundum\Shopware6\Model\SeoUrlFlat',
'seo_url_templates' => '\Rundum\Shopware6\Model\SeoUrlTemplateFlat',
'main_categories' => '\Rundum\Shopware6\Model\MainCategoryFlat',
'product_exports' => '\Rundum\Shopware6\Model\ProductExportFlat',
'analytics' => '\Rundum\Shopware6\Model\SalesChannelAnalyticsFlat',
'customer_groups_registrations' => '\Rundum\Shopware6\Model\CustomerGroupFlat',
'event_actions' => '\Rundum\Shopware6\Model\EventActionFlat',
'bound_customers' => '\Rundum\Shopware6\Model\CustomerFlat',
'wishlists' => '\Rundum\Shopware6\Model\CustomerWishlistFlat'    ];
...
'wishlists' => 'getWishlists'    ];
     ...
     * Sets currencies
     *
     * @param \Rundum\Shopware6\Model\CurrencyFlat $currencies currencies
     *
     * @return $this
     */
     ...
     * Sets languages
     *
     * @param \Rundum\Shopware6\Model\LanguageFlat $languages languages
     *
     * @return $this
     */
     ...
     * Gets countries
     *
     * @return \Rundum\Shopware6\Model\CountryFlat
     */
     ...
     * Sets countries
     *
     * @param \Rundum\Shopware6\Model\CountryFlat $countries countries
     *
     * @return $this
     */
     ...
     *
     * @return \Rundum\Shopware6\Model\PaymentMethodFlat
     */
     ...
     *
     * @param \Rundum\Shopware6\Model\PaymentMethodFlat $payment_methods payment_methods
     *
     * @return $this
     */
     ...
     * Gets type
     *
     * @return \Rundum\Shopware6\Model\SalesChannelTypeFlat
     */
     ...
     * Sets type
     *
     * @param \Rundum\Shopware6\Model\SalesChannelTypeFlat $type type
     *
     * @return $this
     */
     ...
     * Gets customer_group
     *
     * @return \Rundum\Shopware6\Model\CustomerGroupFlat
     */
     ...
     * Sets customer_group
     *
     * @param \Rundum\Shopware6\Model\CustomerGroupFlat $customer_group customer_group
     *
     * @return $this
     */
     ...
     * Sets payment_method
     *
     * @param \Rundum\Shopware6\Model\PaymentMethodFlat $payment_method payment_method
     *
     * @return $this
     */
     ...
     * Sets country
     *
     * @param \Rundum\Shopware6\Model\CountryFlat $country country
     *
     * @return $this
     */
     ...
     * Sets domains
     *
     * @param \Rundum\Shopware6\Model\SalesChannelDomainFlat $domains domains
     *
     * @return $this
     */
     ...
     * Gets system_configs
     *
     * @return \Rundum\Shopware6\Model\SystemConfigFlat
     */
     ...
     * Sets system_configs
     *
     * @param \Rundum\Shopware6\Model\SystemConfigFlat $system_configs system_configs
     *
     * @return $this
     */
     ...
     *
     * @param \Rundum\Shopware6\Model\CategoryFlat $navigation_category navigation_category
     *
     * @return $this
     */
     ...
     *
     * @param \Rundum\Shopware6\Model\CategoryFlat $footer_category footer_category
     *
     * @return $this
     */
     ...
     *
     * @param \Rundum\Shopware6\Model\CategoryFlat $service_category service_category
     *
     * @return $this
     */
     ...
     *
     * @return \Rundum\Shopware6\Model\ProductVisibilityFlat
     */
     ...
     *
     * @param \Rundum\Shopware6\Model\ProductVisibilityFlat $product_visibilities product_visibilities
     *
     * @return $this
     */
     ...
     *
     * @param \Rundum\Shopware6\Model\SalesChannelDomainFlat $hreflang_default_domain hreflang_default_domain
     *
     * @return $this
     */
     ...
     *
     * @return \Rundum\Shopware6\Model\MailHeaderFooterFlat
     */
     ...
     *
     * @param \Rundum\Shopware6\Model\MailHeaderFooterFlat $mail_header_footer mail_header_footer
     *
     * @return $this
     */
     ...
     * Sets mail_templates
     *
     * @param \Rundum\Shopware6\Model\MailTemplateSalesChannelFlat $mail_templates mail_templates
     *
     * @return $this
     */
     ...
     *
     * @return \Rundum\Shopware6\Model\NumberRangeSalesChannelFlat
     */
     ...
     *
     * @param \Rundum\Shopware6\Model\NumberRangeSalesChannelFlat $number_range_sales_channels number_range_sales_channels
     *
     * @return $this
     */
     ...
     *
     * @return \Rundum\Shopware6\Model\PromotionSalesChannelFlat
     */
     ...
     *
     * @param \Rundum\Shopware6\Model\PromotionSalesChannelFlat $promotion_sales_channels promotion_sales_channels
     *
     * @return $this
     */
     ...
     *
     * @return \Rundum\Shopware6\Model\DocumentBaseConfigSalesChannelFlat
     */
     ...
     *
     * @param \Rundum\Shopware6\Model\DocumentBaseConfigSalesChannelFlat $document_base_config_sales_channels document_base_config_sales_channels
     *
     * @return $this
     */
     ...
     * Gets seo_urls
     *
     * @return \Rundum\Shopware6\Model\SeoUrlFlat
     */
     ...
     * Sets seo_urls
     *
     * @param \Rundum\Shopware6\Model\SeoUrlFlat $seo_urls seo_urls
     *
     * @return $this
     */
     ...
     *
     * @return \Rundum\Shopware6\Model\SeoUrlTemplateFlat
     */
     ...
     *
     * @param \Rundum\Shopware6\Model\SeoUrlTemplateFlat $seo_url_templates seo_url_templates
     *
     * @return $this
     */
     ...
     *
     * @return \Rundum\Shopware6\Model\MainCategoryFlat
     */
     ...
     *
     * @param \Rundum\Shopware6\Model\MainCategoryFlat $main_categories main_categories
     *
     * @return $this
     */
     ...
     * Gets analytics
     *
     * @return \Rundum\Shopware6\Model\SalesChannelAnalyticsFlat
     */
     ...
     * Sets analytics
     *
     * @param \Rundum\Shopware6\Model\SalesChannelAnalyticsFlat $analytics analytics
     *
     * @return $this
     */
     ...
     *
     * @param \Rundum\Shopware6\Model\CustomerGroupFlat $customer_groups_registrations customer_groups_registrations
     *
     * @return $this
     */
     ...
     * Gets event_actions
     *
     * @return \Rundum\Shopware6\Model\EventActionFlat
     */
     ...
     * Sets event_actions
     *
     * @param \Rundum\Shopware6\Model\EventActionFlat $event_actions event_actions
     *
     * @return $this
     */
     ...
     *
     * @param \Rundum\Shopware6\Model\CustomerFlat $bound_customers bound_customers
     *
     * @return $this
     */
     ...
     * Gets wishlists
     *
     * @return \Rundum\Shopware6\Model\CustomerWishlistFlat
     */
     ...
     * Sets wishlists
     *
     * @param \Rundum\Shopware6\Model\CustomerWishlistFlat $wishlists wishlists
     *
     * @return $this
     */
