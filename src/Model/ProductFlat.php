...
'updated_at' => '\DateTime',
'translated' => 'object',
'parent' => '\Rundum\Shopware6\Model\ProductFlat',
'children' => '\Rundum\Shopware6\Model\ProductFlat',
'delivery_time' => '\Rundum\Shopware6\Model\DeliveryTimeFlat',
'tax' => '\Rundum\Shopware6\Model\TaxFlat',
'manufacturer' => '\Rundum\Shopware6\Model\ProductManufacturerFlat',
'unit' => '\Rundum\Shopware6\Model\UnitFlat',
'cover' => '\Rundum\Shopware6\Model\ProductMediaFlat',
'prices' => '\Rundum\Shopware6\Model\ProductPriceFlat',
'media' => '\Rundum\Shopware6\Model\ProductMediaFlat',
'cross_sellings' => '\Rundum\Shopware6\Model\ProductCrossSellingFlat',
'cross_selling_assigned_products' => '\Rundum\Shopware6\Model\ProductCrossSellingAssignedProductsFlat',
'configurator_settings' => '\Rundum\Shopware6\Model\ProductConfiguratorSettingFlat',
'visibilities' => '\Rundum\Shopware6\Model\ProductVisibilityFlat',
'search_keywords' => '\Rundum\Shopware6\Model\ProductSearchKeywordFlat',
...
'order_line_items' => '\Rundum\Shopware6\Model\OrderLineItemFlat',
'options' => '\Rundum\Shopware6\Model\PropertyGroupOptionFlat',
'properties' => '\Rundum\Shopware6\Model\PropertyGroupOptionFlat',
'categories' => '\Rundum\Shopware6\Model\CategoryFlat',
'categories_ro' => '\Rundum\Shopware6\Model\CategoryFlat',
'tags' => '\Rundum\Shopware6\Model\TagFlat',
'custom_field_sets' => '\Rundum\Shopware6\Model\CustomFieldSetFlat',
'feature_set' => '\Rundum\Shopware6\Model\ProductFeatureSetFlat',
'wishlists' => '\Rundum\Shopware6\Model\CustomerWishlistProductFlat',
'canonical_product' => '\Rundum\Shopware6\Model\ProductFlat'    ];
...
'blacklist_ids' => 'setBlacklistIds',
'whitelist_ids' => 'setWhitelistIds',
...
'blacklist_ids' => 'getBlacklistIds',
'whitelist_ids' => 'getWhitelistIds',
...
'canonical_product' => 'getCanonicalProduct'    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['blacklist_ids'] = isset($data['blacklist_ids']) ? $data['blacklist_ids'] : null;
        $this->container['whitelist_ids'] = isset($data['whitelist_ids']) ? $data['whitelist_ids'] : null;
    ...
    {
        return $this->container['blacklist_ids'];
    }

    /**
     * Sets blacklist_ids
     *
     * @param string[] $blacklist_ids blacklist_ids
     *
     * @return $this
     */
    public function setBlacklistIds($blacklist_ids)
    {
        $this->container['blacklist_ids'] = $blacklist_ids;
    ...
    {
        return $this->container['whitelist_ids'];
    }

    /**
     * Sets whitelist_ids
     *
     * @param string[] $whitelist_ids whitelist_ids
     *
     * @return $this
     */
    public function setWhitelistIds($whitelist_ids)
    {
        $this->container['whitelist_ids'] = $whitelist_ids;
     ...
     * Sets parent
     *
     * @param \Rundum\Shopware6\Model\ProductFlat $parent parent
     *
     * @return $this
     */
     ...
     * Sets children
     *
     * @param \Rundum\Shopware6\Model\ProductFlat $children children
     *
     * @return $this
     */
     ...
     * Gets delivery_time
     *
     * @return \Rundum\Shopware6\Model\DeliveryTimeFlat
     */
     ...
     * Sets delivery_time
     *
     * @param \Rundum\Shopware6\Model\DeliveryTimeFlat $delivery_time delivery_time
     *
     * @return $this
     */
     ...
     * Gets tax
     *
     * @return \Rundum\Shopware6\Model\TaxFlat
     */
     ...
     * Sets tax
     *
     * @param \Rundum\Shopware6\Model\TaxFlat $tax tax
     *
     * @return $this
     */
     ...
     * Gets manufacturer
     *
     * @return \Rundum\Shopware6\Model\ProductManufacturerFlat
     */
     ...
     * Sets manufacturer
     *
     * @param \Rundum\Shopware6\Model\ProductManufacturerFlat $manufacturer manufacturer
     *
     * @return $this
     */
     ...
     * Gets unit
     *
     * @return \Rundum\Shopware6\Model\UnitFlat
     */
     ...
     * Sets unit
     *
     * @param \Rundum\Shopware6\Model\UnitFlat $unit unit
     *
     * @return $this
     */
     ...
     * Gets cover
     *
     * @return \Rundum\Shopware6\Model\ProductMediaFlat
     */
     ...
     * Sets cover
     *
     * @param \Rundum\Shopware6\Model\ProductMediaFlat $cover cover
     *
     * @return $this
     */
     ...
     * Gets prices
     *
     * @return \Rundum\Shopware6\Model\ProductPriceFlat
     */
     ...
     * Sets prices
     *
     * @param \Rundum\Shopware6\Model\ProductPriceFlat $prices prices
     *
     * @return $this
     */
     ...
     * Sets media
     *
     * @param \Rundum\Shopware6\Model\ProductMediaFlat $media media
     *
     * @return $this
     */
     ...
     * Gets cross_sellings
     *
     * @return \Rundum\Shopware6\Model\ProductCrossSellingFlat
     */
     ...
     * Sets cross_sellings
     *
     * @param \Rundum\Shopware6\Model\ProductCrossSellingFlat $cross_sellings cross_sellings
     *
     * @return $this
     */
     ...
     *
     * @param \Rundum\Shopware6\Model\ProductCrossSellingAssignedProductsFlat $cross_selling_assigned_products cross_selling_assigned_products
     *
     * @return $this
     */
     ...
     *
     * @return \Rundum\Shopware6\Model\ProductConfiguratorSettingFlat
     */
     ...
     *
     * @param \Rundum\Shopware6\Model\ProductConfiguratorSettingFlat $configurator_settings configurator_settings
     *
     * @return $this
     */
     ...
     * Sets visibilities
     *
     * @param \Rundum\Shopware6\Model\ProductVisibilityFlat $visibilities visibilities
     *
     * @return $this
     */
     ...
     *
     * @param \Rundum\Shopware6\Model\ProductSearchKeywordFlat $search_keywords search_keywords
     *
     * @return $this
     */
     ...
     *
     * @param \Rundum\Shopware6\Model\OrderLineItemFlat $order_line_items order_line_items
     *
     * @return $this
     */
     ...
     * Gets options
     *
     * @return \Rundum\Shopware6\Model\PropertyGroupOptionFlat
     */
     ...
     * Sets options
     *
     * @param \Rundum\Shopware6\Model\PropertyGroupOptionFlat $options options
     *
     * @return $this
     */
     ...
     * Sets properties
     *
     * @param \Rundum\Shopware6\Model\PropertyGroupOptionFlat $properties properties
     *
     * @return $this
     */
     ...
     * Sets categories_ro
     *
     * @param \Rundum\Shopware6\Model\CategoryFlat $categories_ro categories_ro
     *
     * @return $this
     */
     ...
     * Gets feature_set
     *
     * @return \Rundum\Shopware6\Model\ProductFeatureSetFlat
     */
     ...
     * Sets feature_set
     *
     * @param \Rundum\Shopware6\Model\ProductFeatureSetFlat $feature_set feature_set
     *
     * @return $this
     */
     ...
     * Sets wishlists
     *
     * @param \Rundum\Shopware6\Model\CustomerWishlistProductFlat $wishlists wishlists
     *
     * @return $this
     */
     ...
     *
     * @param \Rundum\Shopware6\Model\ProductFlat $canonical_product canonical_product
     *
     * @return $this
     */
