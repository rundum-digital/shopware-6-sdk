...
'updated_at' => '\DateTime',
'translated' => 'object',
'parent' => '\Rundum\Shopware6\Model\CategoryFlat',
'children' => '\Rundum\Shopware6\Model\CategoryFlat',
'media' => '\Rundum\Shopware6\Model\MediaFlat',
'products' => '\Rundum\Shopware6\Model\ProductFlat',
'nested_products' => '\Rundum\Shopware6\Model\ProductFlat',
'tags' => '\Rundum\Shopware6\Model\TagFlat',
'cms_page' => '\Rundum\Shopware6\Model\CmsPageFlat',
'product_stream' => '\Rundum\Shopware6\Model\ProductStreamFlat',
'navigation_sales_channels' => '\Rundum\Shopware6\Model\SalesChannelFlat',
'footer_sales_channels' => '\Rundum\Shopware6\Model\SalesChannelFlat',
'service_sales_channels' => '\Rundum\Shopware6\Model\SalesChannelFlat',
...
'seo_urls' => 'getSeoUrls'    ];
     ...
     * Sets parent
     *
     * @param \Rundum\Shopware6\Model\CategoryFlat $parent parent
     *
     * @return $this
     */
     ...
     * Sets children
     *
     * @param \Rundum\Shopware6\Model\CategoryFlat $children children
     *
     * @return $this
     */
     ...
     *
     * @param \Rundum\Shopware6\Model\ProductFlat $nested_products nested_products
     *
     * @return $this
     */
     ...
     * Sets cms_page
     *
     * @param \Rundum\Shopware6\Model\CmsPageFlat $cms_page cms_page
     *
     * @return $this
     */
     ...
     *
     * @param \Rundum\Shopware6\Model\SalesChannelFlat $navigation_sales_channels navigation_sales_channels
     *
     * @return $this
     */
     ...
     *
     * @param \Rundum\Shopware6\Model\SalesChannelFlat $footer_sales_channels footer_sales_channels
     *
     * @return $this
     */
     ...
     *
     * @param \Rundum\Shopware6\Model\SalesChannelFlat $service_sales_channels service_sales_channels
     *
     * @return $this
     */
