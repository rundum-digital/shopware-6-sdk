...
'created_at' => '\DateTime',
'updated_at' => '\DateTime',
'group' => '\Rundum\Shopware6\Model\CustomerGroupFlat',
'default_payment_method' => '\Rundum\Shopware6\Model\PaymentMethodFlat',
'sales_channel' => '\Rundum\Shopware6\Model\SalesChannelFlat',
'language' => '\Rundum\Shopware6\Model\LanguageFlat',
'last_payment_method' => '\Rundum\Shopware6\Model\PaymentMethodFlat',
'default_billing_address' => '\Rundum\Shopware6\Model\CustomerAddressFlat',
'default_shipping_address' => '\Rundum\Shopware6\Model\CustomerAddressFlat',
'salutation' => '\Rundum\Shopware6\Model\SalutationFlat',
'addresses' => '\Rundum\Shopware6\Model\CustomerAddressFlat',
'order_customers' => '\Rundum\Shopware6\Model\OrderCustomerFlat',
'tags' => '\Rundum\Shopware6\Model\TagFlat',
'promotions' => '\Rundum\Shopware6\Model\PromotionFlat',
'product_reviews' => '\Rundum\Shopware6\Model\ProductReviewFlat',
'recovery_customer' => '\Rundum\Shopware6\Model\CustomerRecoveryFlat',
'requested_group' => '\Rundum\Shopware6\Model\CustomerGroupFlat',
'bound_sales_channel' => '\Rundum\Shopware6\Model\SalesChannelFlat',
...
'wishlists' => 'getWishlists'    ];
     ...
     * Sets group
     *
     * @param \Rundum\Shopware6\Model\CustomerGroupFlat $group group
     *
     * @return $this
     */
     ...
     *
     * @param \Rundum\Shopware6\Model\PaymentMethodFlat $default_payment_method default_payment_method
     *
     * @return $this
     */
     ...
     *
     * @param \Rundum\Shopware6\Model\PaymentMethodFlat $last_payment_method last_payment_method
     *
     * @return $this
     */
     ...
     *
     * @return \Rundum\Shopware6\Model\CustomerAddressFlat
     */
     ...
     *
     * @param \Rundum\Shopware6\Model\CustomerAddressFlat $default_billing_address default_billing_address
     *
     * @return $this
     */
     ...
     *
     * @param \Rundum\Shopware6\Model\CustomerAddressFlat $default_shipping_address default_shipping_address
     *
     * @return $this
     */
     ...
     * Gets salutation
     *
     * @return \Rundum\Shopware6\Model\SalutationFlat
     */
     ...
     * Sets salutation
     *
     * @param \Rundum\Shopware6\Model\SalutationFlat $salutation salutation
     *
     * @return $this
     */
     ...
     * Sets addresses
     *
     * @param \Rundum\Shopware6\Model\CustomerAddressFlat $addresses addresses
     *
     * @return $this
     */
     ...
     *
     * @param \Rundum\Shopware6\Model\OrderCustomerFlat $order_customers order_customers
     *
     * @return $this
     */
     ...
     * Sets promotions
     *
     * @param \Rundum\Shopware6\Model\PromotionFlat $promotions promotions
     *
     * @return $this
     */
     ...
     *
     * @return \Rundum\Shopware6\Model\CustomerRecoveryFlat
     */
     ...
     *
     * @param \Rundum\Shopware6\Model\CustomerRecoveryFlat $recovery_customer recovery_customer
     *
     * @return $this
     */
     ...
     *
     * @param \Rundum\Shopware6\Model\CustomerGroupFlat $requested_group requested_group
     *
     * @return $this
     */
     ...
     *
     * @param \Rundum\Shopware6\Model\SalesChannelFlat $bound_sales_channel bound_sales_channel
     *
     * @return $this
     */
